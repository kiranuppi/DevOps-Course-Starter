...
terraform init
terraform apply -var "prefix=production" -var "location=uksouth" -var "resource_group_name=OpenCohort1_KiranUppinkudru_ProjectExercise" -var "DOCKER_REGISTRY_SERVER_USERNAME='$DOCKER_USERNAME'" -var "DOCKER_REGISTRY_SERVER_PASSWORD='$DOCKER_PASSWORD'" -var "GITHUB_CLIENT_ID='$GITHUB_CLIENT_ID'" -var "GITHUB_CLIENT_SECRET='$GITHUB_CLIENT_SECRET'" -var "MONGO_DB_NAME='$MONGO_DB_NAME'" -var "MONGODB_COLLECTION_NAME='$MONGODB_COLLECTION_NAME'" -var "SECRET_KEY='$SECRET_KEY'" -auto-approve
